...
\begin{outerlist}
	\item[] \textit{Fullstack developer}%
		\hfill \textbf{2024 - současnost}
	\begin{innerlist}
		\item Vývoj Mobilní bezpečnostní platformy pro Policii ČR a Ministerstvo vnitra 		
...
\begin{description}
  ...
  \item[Frameworky] React.js, Next.js, Vue.js, Nuxt.js, Express, Flask, Nest.js
  \item[Databázové nástroje] Oracle Db, MongoDb, MSSQL, Postgre
