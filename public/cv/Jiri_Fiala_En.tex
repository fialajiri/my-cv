...
\begin{outerlist}
	...
	\begin{innerlist}
		\item Backend development in Nest.js 		
...
\begin{description}
  ...
  \item[Databases] Oracle Db, MongoDb, MSSQL, Postgre
  \item[Mathematical tools] Matlab, Wolfram, R
  \item[Operating systems] GNU/Linux, Microsoft Windows
  \item[Office tools] Word, Power point, Excel, Outlook
  \item[SQL tools] Oracle SQL Developer, Microsoft SQL Server, MS Access
